...
BOARD_DEFS = -DSTM32H735xx -DTRACE_CPU_MHZ=550
...
BOARD_BSP_THREADX = $(BOARD_DIR)/crt0.S $(BOARD_DIR)/vectors.S \
                    $(BOARD_DIR)/tx_initialize_low_level.S $(BOARD_DIR)/board.c
BOARD_BSP_BARE    = $(BOARD_DIR)/startup.c $(BOARD_DIR)/board.c

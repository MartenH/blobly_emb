...
fn emit_manifest(m Model, doc toml.Doc, ecu string, comm_thread_on bool, single_part string, bridge_bus_list []string, trace_host bool) []string {
	mut man := []string{}
...
fn main() {
	...
	if args.len >= 7 {
		man := emit_manifest(m, doc, ecu, comm_thread_on, single_part, bridge_bus_list, trace_host)

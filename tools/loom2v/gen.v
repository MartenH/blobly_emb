...
fn main() {
	...
	// Multi-core (P3a): one shared scratch slot is the SYSTEM-WIDE FREEZE flag. When any core's
	// capture overruns it sets this; every core's capture hook sees it and triggers its own ring,
	// so a dump is a coherent cross-core snapshot (all cores frozen around the same instant) rather
	// than each core frozen whenever it happened to stop. Reserved after telem's slots.
